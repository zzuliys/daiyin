...
int main()
{
    ...
    // 打开明文文件和输出文件
    std::ifstream inputFile("C:\\Users\\daiyin\\Desktop\\daiyin\\encryption\\OrbbecSDK.license", std::ios::binary);
    std::ofstream outputFile("C:\\Users\\daiyin\\Desktop\\daiyin\\encryption\\OrbbecSDK_encryption.license", std::ios::binary);
