...
int main()
{
    ...
    // 打开明文文件和输出文件
    std::ifstream inputFile("C:/Users/daiyin/Desktop/daiyin/encryption/encryption_target/OrbbecSDK.license.xml", std::ios::binary);
    std::ofstream outputFile("C:/Users/daiyin/Desktop/daiyin/encryption/decrypt_target/OrbbecSDK.license.xml", std::ios::binary);
